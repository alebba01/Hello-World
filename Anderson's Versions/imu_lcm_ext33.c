...
int data_imu_pos(){
    ...
    int t=0,i,k=0,j=0,l,i0,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,j1,d,dp,test;
...
// The standard position message structure.
    ...
    data_pos[0]=0xFA;data_pos[1]=0xFF;data_pos[2]=0x32;data_pos[3]=0x3E;
