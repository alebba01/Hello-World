...
char longHolder[11],latHolder[11],rollHolder[7],pitchHolder[7],yawHolder[7];

char sendBuffer[]="Lat:0000.000000 Long:0000.000000 Roll:0000.00 Pitch:0000.00 Yaw:0000.00 \r\n";  
...
//			printf("\n Latitude= %f Longitude= %f Altitude= %f roll= %f pitch= %f yaw= %f %s\n",latitude,longitude,altitude,roll,pitch,yaw,asctime(timeinfo)); 
			...
			if (test>60){ 
				...
				sprintf(rollHolder,"%+07.2f",roll);

				sprintf(pitchHolder,"%+07.2f",pitch);

				sprintf(yawHolder,"%+07.2f",yaw);
				...
				sendBuffer[56]=pitchHolder[0];

				sendBuffer[57]=pitchHolder[1];

				sendBuffer[58]=pitchHolder[2];

				sendBuffer[59]=pitchHolder[3];

				sendBuffer[60]=pitchHolder[4];

				sendBuffer[61]=pitchHolder[5];

				sendBuffer[62]=pitchHolder[6];
				...
				sendBuffer[68]=yawHolder[0];

				sendBuffer[69]=yawHolder[1];

				sendBuffer[70]=yawHolder[2];

				sendBuffer[71]=yawHolder[3];

				sendBuffer[72]=yawHolder[4];

				sendBuffer[73]=yawHolder[5];

				sendBuffer[74]=yawHolder[6];
