...
char sendBuffer[]="Yaw:0000.000000 \r\n";  
...
//			printf("\n Latitude= %f Longitude= %f Altitude= %f roll= %f pitch= %f yaw= %f %s\n",latitude,longitude,altitude,roll,pitch,yaw,asctime(timeinfo)); 
			...
			if (test>60){ 
				...
				sendBuffer[4]=yawHolder[0];

				sendBuffer[5]=yawHolder[1];

				sendBuffer[6]=yawHolder[2];

				sendBuffer[7]=yawHolder[3];

				sendBuffer[8]=yawHolder[4];

				sendBuffer[9]=yawHolder[5];

				sendBuffer[10]=yawHolder[6];

				sendBuffer[11]=yawHolder[7];

				sendBuffer[12]=yawHolder[8];

				sendBuffer[13]=yawHolder[9];

				sendBuffer[14]=yawHolder[10];
