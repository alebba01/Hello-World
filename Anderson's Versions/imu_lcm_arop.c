...
char accxHolder[7],accyHolder[7],acczHolder[7],gyrxHolder[7],gyryHolder[7],gyrzHolder[7],rollHolder[11],pitchHolder[11],yawHolder[11],latHolder[11],longHolder[11],altHolder[5];

char sendBuffer[]="AccX:00.0000 AccY:00.0000 AccZ:00.0000 GyrX:00.0000 GyrY:00.0000 GyrZ:00.0000 Roll:0000.000000 Pitch:0000.000000 Yaw:0000.000000 Lat:0000.000000 Long:0000.000000 Alt:00.00 \r\n";  
...
int data_imu_pos(){
    ...
    char data_pos[53],crc,data[80],data_pos1[53];

    int length=53,t=0,i,k=0,j=0,l,i1,j1,test,d0,d1,d2,d3,dp0,dp1,dp2,dp3;
    ...
    float accx,accy,accz,gyrx,gyry,gyrz,roll,pitch,yaw,latitude,longitude,altitude;

// The standard position message structure.

    data_pos[0]=0xFA;data_pos[1]=0xFF;data_pos[2]=0x32;data_pos[3]=0x30;
...
// Get the Lat, Lon, Alt and write them into a Binary Datafile for now.
		...
		if (crc_val==0) {
			...
			printf("AccX:%7.4f AccY:%7.4f AccZ:%7.4f GyrX:%7.4f GyrY:%7.4f GyrZ:%7.4f Roll:%11.6f Pitch:%11.6f Yaw:%11.6f Lat:%11.6f Long:%11.6f Alt:%11.6f \n",accx,accy,accz,gyrx,gyry,gyrz,roll,pitch,yaw,latitude,longitude,altitude);
...
int main(){ 
    ...
    msgout[0]=0xFA;msgout[1]=0xFF;msgout[2]=0xD0;msgout[3]=0x02;msgout[4]=00;msgout[5]=0x16;msgout[6]=0x19;
