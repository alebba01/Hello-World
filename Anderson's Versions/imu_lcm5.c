...
char longHolder[11],latHolder[11],rollHolder[8],pitchHolder[8],yawHolder[8];

char sendBuffer[]="Roll:0000.000000 Pitch:0000.000000 Yaw:0000.000000 \r\n";  
...
//			printf("\n Latitude= %f Longitude= %f Altitude= %f roll= %f pitch= %f yaw= %f %s\n",latitude,longitude,altitude,roll,pitch,yaw,asctime(timeinfo)); 
			...
			if (test>60){ 
				...
				sendBuffer[5]=rollHolder[0];

				sendBuffer[6]=rollHolder[1];

				sendBuffer[7]=rollHolder[2];

				sendBuffer[8]=rollHolder[3];

				sendBuffer[9]=rollHolder[4];

				sendBuffer[10]=rollHolder[5];

				sendBuffer[11]=rollHolder[6];

				sendBuffer[12]=rollHolder[7];

				sendBuffer[13]=rollHolder[8];

				sendBuffer[14]=rollHolder[9];

				sendBuffer[15]=rollHolder[10];



				// Pitch

				sendBuffer[23]=pitchHolder[0];

				sendBuffer[24]=pitchHolder[1];

				sendBuffer[25]=pitchHolder[2];

				sendBuffer[26]=pitchHolder[3];

				sendBuffer[27]=pitchHolder[4];

				sendBuffer[28]=pitchHolder[5];

				sendBuffer[29]=pitchHolder[6];

				sendBuffer[30]=pitchHolder[7];

				sendBuffer[31]=pitchHolder[8];

				sendBuffer[32]=pitchHolder[9];

				sendBuffer[33]=pitchHolder[10];
				...
				sendBuffer[39]=yawHolder[0];

				sendBuffer[40]=yawHolder[1];

				sendBuffer[41]=yawHolder[2];

				sendBuffer[42]=yawHolder[3];

				sendBuffer[43]=yawHolder[4];

				sendBuffer[44]=yawHolder[5];

				sendBuffer[45]=yawHolder[6];

				sendBuffer[46]=yawHolder[7];

				sendBuffer[47]=yawHolder[8];

				sendBuffer[48]=yawHolder[9];

				sendBuffer[49]=yawHolder[10];
