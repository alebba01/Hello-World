...
char sendBuffer[]="GPS Lat:0000.000000 Long:0000.000000 Roll:000.0000 Pitch:000.0000 Yaw:000.0000 \r\n";  
...
//			printf("\n Latitude= %f Longitude= %f Altitude= %f roll= %f pitch= %f yaw= %f %s\n",latitude,longitude,altitude,roll,pitch,yaw,asctime(timeinfo)); 
			...
			if (test>60){ 
				...
				sprintf(rollHolder,"%+008.4f",roll);

				sprintf(pitchHolder,"%+008.4f",pitch);

				sprintf(yawHolder,"%+008.4f",yaw);
				...
				sendBuffer[57]=pitchHolder[0];

				sendBuffer[58]=pitchHolder[1];

				sendBuffer[59]=pitchHolder[2];

				sendBuffer[60]=pitchHolder[3];

				sendBuffer[61]=pitchHolder[4];

				sendBuffer[62]=pitchHolder[5];

				sendBuffer[63]=pitchHolder[6];

				sendBuffer[64]=pitchHolder[7];
				...
				sendBuffer[70]=yawHolder[0];

				sendBuffer[71]=yawHolder[1];

				sendBuffer[72]=yawHolder[2];

				sendBuffer[73]=yawHolder[3];

				sendBuffer[74]=yawHolder[4];

				sendBuffer[75]=yawHolder[5];

				sendBuffer[76]=yawHolder[6];

				sendBuffer[77]=yawHolder[7];
