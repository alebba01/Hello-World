...
int data_imu_pos(){
    ...
    char data_pos[70],crc,data[88],data_pos1[70];

    int crc_val,t=0,i,k=0,j=0,l,i0,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,j1,test,d0,d1,d2,d3,dp0,dp1,dp2,dp3;
