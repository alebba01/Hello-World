...
char accxHolder[7],accyHolder[7],acczHolder[7],gyrxHolder[7],gyryHolder[7],gyrzHolder[7];

char sendBuffer[]="AccX:00.0000 AccY:00.0000 AccZ:00.0000 GyrX:00.0000 GyrY:00.0000 GyrZ:00.0000 \r\n";  
...
int data_imu_pos(){
    ...
    char data_pos[29],crc,data[50],data_pos1[29];
...
// The standard position message structure.
    ...
    data_pos[0]=0xFA;data_pos[1]=0xFF;data_pos[2]=0x32;data_pos[3]=0x18;
...
// Get the Lat, Lon, Alt and write them into a Binary Datafile for now.
		...
		if (crc_val==0) {
			...
			printf("AccX:%7.4f AccY:%7.4f AccZ:%7.4f GyrX:%7.4f GyrY:%7.4f GyrZ:%7.4f \n",accx,accy,accz,gyrx,gyry,gyrz);
