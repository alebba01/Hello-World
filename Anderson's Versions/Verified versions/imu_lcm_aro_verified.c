...
char accxHolder[7],accyHolder[7],acczHolder[7],gyrxHolder[7],gyryHolder[7],gyrzHolder[7],rollHolder[11],pitchHolder[11],yawHolder[11];

char sendBuffer[]="AccX:00.0000 AccY:00.0000 AccZ:00.0000 GyrX:00.0000 GyrY:00.0000 GyrZ:00.0000 Roll:0000.000000 Pitch:0000.000000 Yaw:0000.000000 \r\n";  
...
int data_imu_pos(){
    ...
    char data_pos[41],crc,data[50],data_pos1[41];

    int length=41,t=0,i,k=0,j=0,l,i1,j1,test,d0,d1,d2,d3,dp0,dp1,dp2,dp3;
    ...
    float accx,accy,accz,gyrx,gyry,gyrz,roll,pitch,yaw;

// The standard position message structure.

    data_pos[0]=0xFA;data_pos[1]=0xFF;data_pos[2]=0x32;data_pos[3]=0x24;
...
// Get the Lat, Lon, Alt and write them into a Binary Datafile for now.
		...
		if (crc_val==0) {
			...
			printf("AccX:%7.4f AccY:%7.4f AccZ:%7.4f GyrX:%7.4f GyrY:%7.4f GyrZ:%7.4f Roll:%11.6f Pitch:%11.6f Yaw:%11.6f \n",accx,accy,accz,gyrx,gyry,gyrz,roll,pitch,yaw);
...
int main(){ 
    ...
    msgout[0]=0xFA;msgout[1]=0xFF;msgout[2]=0xD0;msgout[3]=0x02;msgout[4]=00;msgout[5]=0x06;msgout[6]=0x29;
