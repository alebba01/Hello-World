...
int data_imu_pos(){
    ...
    char data_pos[9],crc,data[50],data_pos1[9];

    int t=0,i,k=0,j=0,l,i1,j1,test,d0,d1,d2,d3,dp0,dp1,dp2,dp3,dp4,dp5,dp6,dp7,dp8;
...
// The standard position message structure.
    ...
    data_pos[0]=0xFA;data_pos[1]=0xFF;data_pos[2]=0x32;data_pos[3]=0x04;
...
//Confirm message
	...
	printf("Data_pos:%d %d %d %d %d %d %d %d %d \n",dp0,dp1,dp2,dp3,dp4,dp5,dp6,dp7);


// Do the Checksum

		crc_val=(data_pos[1] & 0xFF);

		for(i=2; i<9; ++i)

			crc_val+=(data_pos[i] & 0xFF);
...
int main(){ 
    ...
    msgout[0]=0xFA;msgout[1]=0xFF;msgout[2]=0xD0;msgout[3]=0x02;msgout[4]=00;msgout[5]=0x01;msgout[6]=0x2E;
	...
	msgoutsettings[0]=0xFA;msgoutsettings[1]=0xFF;msgoutsettings[2]=0xD2;msgoutsettings[3]=0x04;msgoutsettings[4]=0x80;msgoutsettings[5]=0x00;msgoutsettings[6]=0x0C;msgoutsettings[7]=0x74;msgoutsettings[8]=0x2B;
