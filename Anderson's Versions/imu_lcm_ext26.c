...
int data_imu_pos(){
    ...
    char data_pos[67],crc,data[100],data_pos1[67];

    int t=0,i,k=0,j=0,l,i0,i1,i2,i3,i4,i5,i6,i7,i8,i9,i10,i11,i12,i13,i14,i15,i16,j1,test;
...
// The standard position message structure.
    ...
    data_pos[0]=0xFA;data_pos[1]=0xFF;data_pos[2]=0x32;data_pos[3]=0x3D;
...
// make chunks of 100 bytes of data.

				if(j>99) {

					j=0;

					for (i0=0;i0<100-30;i0++){

						printf("data:%x data_pos:%x \n",data,data_pos);
...
int main(){ 
	...
	//Messages for communicating and setting up the IMU.
         ...
         msgout[0]=0xFA;msgout[1]=0x01;msgout[2]=0xD0;msgout[3]=0x02;msgout[4]=0x00;msgout[5]=0x37;msgout[6]=0xF8;

         //expected output mode acknowledge message

         msgoutack[0]=0xFA;msgoutack[1]=0x01;msgoutack[2]=0xD1;msgoutack[3]=0x00;msgoutack[4]=0x30;

         //change output mode settings

         msgoutsettings[0]=0xFA;msgoutsettings[1]=0x01;msgoutsettings[2]=0xD2;msgoutsettings[3]=0x04;msgoutsettings[4]=0x10;msgoutsettings[5]=0x00;msgoutsettings[6]=0x0C;msgoutsettings[7]=0x44;msgoutsettings[8]=0xCB;

         //expected output mode settings acknowledge message

         msgoutsettingsack[0]=0xFA;msgoutsettingsack[1]=0x01;msgoutsettingsack[2]=0xD3;msgoutsettingsack[3]=0x00;msgoutsettingsack[4]=0x2E;
